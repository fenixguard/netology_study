...
from config import API_URL, API_VERSION, VK_TOKEN, FIELDS
...
class User:
    ...
    def __init__(self, user_id):
        ...
        if user_id.isdigit() is False:
            params_init = dict(access_token=VK_TOKEN, user_ids=user_id, v=API_VERSION)
    ...
    def get_user_data(self):
        method_url = f'{API_URL}/users.get'
        params_users_get = dict(access_token=VK_TOKEN, user_ids=self.user_id, v=API_VERSION, fields=FIELDS)
    ...
    def get_groups(self):
        ...
        params_get_groups = dict(access_token=VK_TOKEN, user_id=self.user_id, count=1000, v=API_VERSION)
        try:
    ...
    def get_photos(self):
        ...
        params_get_groups = dict(access_token=VK_TOKEN, owner_id=self.user_id, count=1000, v=API_VERSION,
    ...
    def search_users(self, sex, age_from, age_to, offset):
        ...
        params_users_search = dict(access_token=VK_TOKEN, v=API_VERSION, fields=FIELDS,
